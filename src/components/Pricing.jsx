  ...
  return (
    <section className="bg-page">
      <div className="mx-auto max-w-[1180px] px-6 pb-8 pt-8 lg:px-10">
        <h2 className="text-center font-serif text-[27px] text-ink">Begin by finding the dependency.</h2>
        <div className="mt-5 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl bg-cream px-8 pb-6 pt-5 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[460px] text-[13px] leading-[1.7] text-body">
            ...
            <Link
              ...
              className="mt-5 inline-block rounded-md bg-brand px-16 py-2.5 text-[14px] font-semibold text-white shadow-sm transition hover:bg-brand-dark"
            >
              Book a founder scan
            </Link>
          </div>
          ...
          <div className="rounded-xl bg-mint-soft px-8 pb-6 pt-5 text-center">
            ...
            <p className="mt-1 font-serif text-ink">
              ...
              <span className="ml-2 font-sans text-[20px] text-body">per company + VAT</span>
            </p>
            <p className="mx-auto mt-3 max-w-[460px] text-[13px] leading-[1.7] text-body">
            ...
            <Link
              to="/pricing"
              className="mt-7 inline-flex items-center gap-2.5 text-[14px] font-semibold text-brand hover:underline"
            >
