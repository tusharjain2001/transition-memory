    ...
    <>
      ...
      <main>
        ...
        <section id="advisers" className="bg-page">
          <Container className="grid items-start gap-8 pb-12 pt-8 lg:grid-cols-[1.05fr_1.1fr]">
            <div>
              <Eyebrow>For trusted advisers</Eyebrow>
              <h1 className="mt-4 font-serif text-[34px] leading-[1.15] text-ink sm:text-[38px]">
              ...
              <p className="mt-6 max-w-[380px] text-[13px] leading-[1.6] text-body">
        ...
        <section className="bg-cream">
          <Container className="py-8 text-center">
            <h2 className="font-serif text-[25px] leading-[1.3] text-ink">
              The accounts can be ready for sale while the business is not ready to lose its owner.
            </h2>
            <p className="mx-auto mt-3 max-w-[620px] text-[13.5px] leading-[1.7] text-body">
            ...
            <div className="mt-7 grid grid-cols-2 gap-5 lg:grid-cols-4">
              {who.map((w) => (
                <Card key={w.title} className="flex min-h-[120px] flex-col items-center justify-center px-4 py-6 text-center">
                  ...
                  <p className="mt-3 whitespace-pre-line font-serif text-[17px] leading-[1.25] text-ink-soft">{w.title}</p>
                </Card>
              ))}
            </div>
            <p className="mt-6 text-center text-[13.5px] text-body">
        ...
        <section className="bg-brand text-white">
          <Container className="grid gap-10 py-10 lg:grid-cols-[1.15fr_1fr]">
            <div>
              <h2 className="font-serif text-[27px]">When to introduce us.</h2>
              <p className="mt-4 text-[14px] font-semibold">Useful signals</p>
        ...
        <section className="bg-page">
          <Container className="pb-8 pt-10">
            ...
            <p className="mt-8 text-center text-[13.5px] text-brand">
        ...
        <section className="bg-mint">
          <Container className="py-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-y-6 md:grid-cols-3 lg:grid-cols-6">
              {receives.map((r, i) => (
                ...
                >
                  ...
                  <p className="mt-4 whitespace-pre-line font-serif text-[15px] leading-[1.3] text-ink-soft">{r.title}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-2 text-center">
              <ArrowLink to="/for-owners" className="font-serif text-[20px] font-normal">
        ...
        <section className="bg-page">
          <Container className="grid gap-10 pb-10 pt-8 lg:grid-cols-[1.9fr_1fr]">
            <div>
              <h2 className="font-serif text-[25px] text-ink lg:pl-16">Knowledge the successor can continue to use.</h2>
              <div className="mt-4 grid gap-4 md:grid-cols-[1.75fr_1fr]">
                <Card className="px-6 pb-5 pt-5">
                  <h3 className="font-serif text-[19px] text-ink">Why was this customer offered different payment terms?</h3>
                  <p className="mt-3 text-[13.5px] leading-[1.6] text-[#1f2a28]">
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-2">
                    <span className="rounded bg-mint px-3 py-1.5 text-[11.5px] text-brand">Founder interview</span>
                    <span className="rounded bg-mint px-3 py-1.5 text-[11.5px] text-brand">Customer record</span>
                ...
                <Card className="px-5 py-5">
                  <CheckList items={knowledgePoints} size="sm" className="space-y-3.5 text-[12px]" />
                </Card>
              </div>

              <h2 className="mt-8 font-serif text-[25px] text-ink">A low-friction starting point.</h2>
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <Card className="px-6 pb-5 pt-5">
                  <h3 className="font-serif text-[20px] text-ink-soft">Founder Dependency Scan</h3>
                  <p className="mt-1 font-serif text-ink">
                    <span className="text-[24px]">£500</span>
                    <span className="ml-2 font-sans text-[15px] text-body">+ VAT</span>
                  </p>
                  ...
                  <CheckList
                    plain size="sm" className="mt-3 space-y-1.5 text-[12px]"
                ...
                <Card className="px-6 pb-5 pt-5">
                  <h3 className="font-serif text-[20px] text-ink-soft">Verified Owner Transfer</h3>
                  <p className="mt-1 font-serif text-ink">
                    <span className="text-[18px]">From </span>
                    <span className="text-[24px]">£5,000</span>
                    <span className="ml-2 font-sans text-[15px] text-body">per company</span>
                  </p>
                  <CheckList
                    plain size="sm" className="mt-3 space-y-1.5 text-[12px]"
            ...
            <div>
              <h2 className="font-serif text-[25px] text-ink">Ways to introduce a client</h2>
              <div className="mt-4 space-y-4">
                {ways.map((w) => (
                  <Card key={w.title} className="flex gap-5 px-5 py-5">
                    <div className="flex-shrink-0 text-brand">{w.icon}</div>
                    <div>
                      <h3 className="font-serif text-[19px] text-ink-soft">{w.title}</h3>
                      <p className="mt-1 text-[12.5px] leading-[1.6] text-body">{w.body}</p>
                    </div>
                  </Card>
                ))}
              </div>
